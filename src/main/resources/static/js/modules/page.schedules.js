...
Router.register('schedules', function(panel) {
  ...
  const cards = [
    ...
    { id:'pocket-ins-schedule', icon:'🏥', name:'Pocket Insurance',
      sub:'Assurekit', desc:'Active + Sub-Cancel + Accrual Entry · ₹1,550 net commission',
      badge:'Live', badgeClr:'#1D6F42', badgeBg:'#D9F0D9',
    ...
    { id:'rto-schedule',      icon:'🚦', name:'RTO Schedule',
      ...
      badge:'Soon', badgeClr:'#8A6010', badgeBg:'#FFF3CD',
      accent:'#1E3F6B', ready:false },
    { id:'holdback-schedule', icon:'🔒', name:'Holdback Schedule',
      sub:'Schedule', desc:'Customer holdback release & reconciliation register',
      badge:'Soon', badgeClr:'#8A6010', badgeBg:'#FFF3CD',
      accent:'#1E3F6B', ready:false },
